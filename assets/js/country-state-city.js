...
/*================================================================================
  ARRAY OF LOCAL GOVERNMENTS WITH THEIR RESPECTIVE STATES
==================================================================================*/
var parts = 
{
  "Abia": [
...
let lgaGroup = document.querySelector("#lgaGroup");
let cityGroup = document.querySelector("#cityGroup");
...
state.addEventListener("change", (e) => {
  ...
  let getLGAs = parts[selectedState];
  getLGAs.forEach(lg => {
    let option = document.createElement('option');
    option.value = lg;
